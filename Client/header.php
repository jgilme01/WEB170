...
function preloadImages() {
	if (document.images) {
		fre_06_over = newImage("<?php bloginfo('template_directory');?>/images/fre_06-over.jpg");
		fre_08_over = newImage("<?php bloginfo('template_directory');?>/images/fre_08-over.jpg");
		fre_09_over = newImage("<?php bloginfo('template_directory');?>/images/fre_09-over.jpg");
		fre_10_over = newImage("<?php bloginfo('template_directory');?>/images/fre_10-over.jpg");
		fre_11_over = newImage("<?php bloginfo('template_directory');?>/images/fre_11-over.jpg");
		fre_12_over = newImage("<?php bloginfo('template_directory');?>/images/fre_12-over.jpg");
		preloadFlag = true;
	}
}
...
<div id="navigation">
            ...
            <?php wp_nav_menu( array( 'theme_location' => 'main-menu', 'container' => 'div','container_id' => 'navigation', ) ); ?>
			  ...
			  <!-- Start console section --><!-- End console section -->
